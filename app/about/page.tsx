...
const values = [
  {
    icon: Zap,
    name: "Innovation",
    description: "Pushing the boundaries of electric vehicle technology",
  },
  {
    icon: Users,
    name: "Teamwork",
    description: "Collaborating across disciplines to achieve our goals",
  },
  {
    icon: Lightbulb,
    name: "Creativity",
    description: "Finding unique solutions to complex engineering challenges",
  },
  {
    icon: Trophy,
    name: "Excellence",
...
const techStack = [
  {
    ...
    description: "State-of-the-art motor control and power management",
  },
  {
    icon: Cog,
    name: "CAD/CAM Software",
    description: "Precision design and manufacturing tools",
  },
  {
    icon: Battery,
  ...
  },
  {
    icon: Shield,
    name: "Safety Systems",
    description: "Cutting-edge safety and data acquisition technology",
  },
];
          ...
          <div className="absolute inset-0 flex items-center justify-center">
            <div className="text-center text-vintage-white">
              <h1 className="section-title text-4xl md:text-5xl font-bold mb-4">
                ABOUT UCI FORMULA SAE
              </h1>
              <p className="text-xl md:text-2xl">
                Driving the Future of Electric Racing
              </p>
            </div>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-xl text-vintage-navy leading-relaxed">
                ...
                racing cutting-edge electric vehicles. Our mission is to push
                the boundaries of sustainable automotive technology while
                providing hands-on engineering experience to students passionate
                about innovation and motorsports.
              </p>
            </div>
          </div>
        </section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {values.map((value) => (
                ...
                >
                  ...
                  <h3 className="text-xl font-semibold mb-2 text-vintage-navy">
                    {value.name}
                  </h3>
